(function (app) {
    ...
    appUserListController.$inject = ['$scope', '$ngBootbox', 'apiService', 'notificationService'];

    function appUserListController($scope, $ngBootbox, apiService, notificationService) {
        $scope.loading = true;
        $scope.data = [];
        $scope.page = 0;
        $scope.pageCount = 0;
